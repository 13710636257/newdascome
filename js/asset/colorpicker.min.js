define(function (require, exports, module) {
    'use strict';
    var ColorPicker = (function (s, t, u) {
        ...
        if (v == 'SVG') {
            slide = $('svg', {
                ...
                'stop-color': '#FFFF00',
                'stop-opacity': '1'
            }), $('stop', {offset: '100%', 'stop-color': '#FF0000', 'stop-opacity': '1'})])), $('rect', {
                x: '0',
                y: '0',
                width: '100%',
                height: '100%',
            ...
            if (!t.namespaces['v'])t.namespaces.add('v', 'urn:schemas-microsoft-com:vml', '#default#VML')
        }
        function hsv2rgb(a) {
            var R, G, B, X, C;
            var h = (a.h % 360) / 60;
        ...
        function ColorPicker(f, g, h) {
            ...
            if (v == 'SVG') {
                ...
                var n = l.getElementsByTagName('linearGradient')[0];
                var o = l.getElementsByTagName('rect')[0];
                n.id = 'gradient-hsv-' + x;
                o.setAttribute('fill', 'url(#' + n.id + ')');
                var p = [m.getElementsByTagName('linearGradient')[0], m.getElementsByTagName('linearGradient')[1]];
        ...
        // 2017-10-19 修改不以window全局下下暴露
        // 只允许 amd 加载
        s.ColorPicker = ColorPicker//全局暴露
        return ColorPicker // 返回模块
